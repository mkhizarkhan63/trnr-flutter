...
import 'package:trainr/view/Client/Client Calendar/clientCalendar_viewModel.dart';
import 'package:trainr/view/Client/components/RowAppointment.dart';

class ClientCalendarView extends StatelessWidget {
  const ClientCalendarView({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
      viewModelBuilder: () => ClientCalendarViewModel(),
      builder: (context, ClientCalendarViewModel viewModel, index) {
        return Scaffold(
    ...
    return const Column(
      children: [
        Text(
          "Calendar",
          style: TextStyle(
              color: Colors.black, fontSize: 24, fontFamily: 'verdanab'),
        ),
        Divider(
          color: Colors.black,
        )
  ...
  Widget _calenderView(
      BuildContext context, ClientCalendarViewModel viewModel) {
